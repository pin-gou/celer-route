...
func (s *RDBConfigStore) UpdateClientConfig(ctx context.Context, config *ClientConfig) error {
	dbConfig := tables.TableClientConfig{
		...
		LogOutputStyle:                        config.LogOutputStyle,
		LogRetentionDays:                      config.LogRetentionDays,
		PayloadRetentionDays:                  config.PayloadRetentionDays,
		...
		CelerRouteBaseURL:                     mcpExternalURLToString(config.CelerRouteBaseURL),
...
func (s *RDBConfigStore) GetClientConfig(ctx context.Context) (*ClientConfig, error) {
	...
	return &ClientConfig{
		...
		LogOutputStyle:                 dbConfig.LogOutputStyle,
		LogRetentionDays:               dbConfig.LogRetentionDays,
		PayloadRetentionDays:           dbConfig.PayloadRetentionDays,
		...
		CelerRouteBaseURL:                     schemas.NewSecretVar(dbConfig.CelerRouteBaseURL),
