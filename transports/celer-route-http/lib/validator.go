...
const (
	DefaultConfigSchemaURL = "https://pin-gou.github.io/celer-route/schema"
...
var localSchemaCandidates = []string{
	...
	"../config.schema.json",         // running from transports/celer-route-http/
	"../../config.schema.json",      // running from transports/celer-route-http/lib/
