				...
				<div className="space-y-3 px-5 py-4">
						...
						<>
							<InfoBox icon={<KeyRound className="size-4" />}>
								...
								<p className="text-muted-foreground/80 text-xs">
									You will be asked to provide sample values for the required headers. celer-route keeps these values on file to
									periodically refresh the available tool list; they are never used for real end-user requests. Once verified, each user
									will submit their own header values when they use this MCP server.
								</p>
							</InfoBox>
					...
					{status === "input" && (
						<>
							<InfoBox icon={<KeyRound className="size-4" />}>
								<p>
									These values verify the connection now and are kept on file so celer-route can periodically refresh the available tool
