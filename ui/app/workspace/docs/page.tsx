...
const docSections = [
	{
		title: "Quick Start",
		description: "Get celer-route running in under 30 seconds",
		icon: Play,
		url: "https://github.com/pin-gou/celer-route/tree/main/docs/quickstart",
		badge: "Popular",
		items: ["HTTP Transport Setup", "Go Package Usage", "Docker Guide"],
	},
	{
		title: "Architecture",
		description: "Deep dive into celer-route's design and performance",
		icon: GitBranch,
		url: "https://github.com/pin-gou/celer-route/tree/main/docs/architecture",
	...
	},
	{
		...
		icon: BookOpen,
		url: "https://github.com/pin-gou/celer-route/tree/main/docs/usage",
		badge: "Comprehensive",
		items: ["Providers Setup", "Key Management", "Error Handling", "Memory & Networking"],
	},
	{
		title: "Contributing",
		description: "Help improve celer-route for everyone",
		icon: Users,
		url: "https://github.com/pin-gou/celer-route/tree/main/docs/contributing",
	...
	},
	{
		...
		icon: Code,
		url: "https://github.com/pin-gou/celer-route/tree/main/docs/usage/http-transport/integrations",
	...
	},
	{
		...
		icon: Zap,
		url: "https://github.com/pin-gou/celer-route/blob/main/docs/benchmarks.md",
...
const featuredDocs = [
	{
		...
		href: "https://github.com/pin-gou/celer-route/blob/main/docs/mcp.md",
		icon: FileText,
	...
	},
	{
		...
		href: "https://github.com/pin-gou/celer-route/blob/main/docs/governance.md",
		icon: Shield,
			...
			<div className="mx-auto max-w-7xl">
				<div className="space-y-8">
					...
					<div className="space-y-4 text-center">
						...
						<GradientHeader title="Power Up Your celer-route Stack" />
						<p className="text-muted-foreground mx-auto max-w-2xl text-lg">
							Everything you need to know about building production AI applications with celer-route
						</p>
						<div className="flex justify-center gap-4">
							<Button asChild>
								<a
									href="https://github.com/pin-gou/celer-route/tree/main/docs"
									target="_blank"
							...
							<Button variant="outline" asChild>
								<a
									href="https://github.com/pin-gou/celer-route/tree/main/docs/quickstart"
									target="_blank"
									rel="noopener noreferrer"
