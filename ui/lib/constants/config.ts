...
export const ModelPlaceholders = {
	...
	snowflake: "e.g. llama3.1-70b, mistral-large2, snowflake-arctic-embed",
	databricks: "e.g. databricks-dbrx-instruct, meta-llama-3.1-70b-instruct",
	oci: "e.g. meta.llama-3.1-70b-instruct, cohere.command-r-plus",
	sap: "e.g. llama3-70b-instruct, gpt-4o",
	modal: "e.g. meta-llama-3.1-70b-instruct",
	baseten: "e.g. llama-3.3-70b-instruct",
	longcat: "e.g. LongCat-2.0",
...
export const ProviderWebsites: Partial<Record<ProviderName, string>> = {
	...
	oci: "https://www.oracle.com/artificial-intelligence/generative-ai",
	sap: "https://help.sap.com/docs/sap-ai-core/sap-ai-core-service-guide/generative-ai-hub-in-sap-ai-core",
...
export const ProviderApiKeyUrls: Partial<Record<ProviderName, string>> = {
	...
	baseten: "https://baseten.co/settings",
...
export const ProviderDefaultBaseUrls: Partial<Record<ProviderName, string>> = {
	...
	oci: "https://inference.generativeai.us-chicago-1.oci.oraclecloud.com/openai",
	sap: "https://api.ai.prod.eu-central-1.aws.ml.hana.ondemand.com",
	modal: "https://api.modal.com",
	baseten: "https://bridge.baseten.co",
