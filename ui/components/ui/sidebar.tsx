...
function Sidebar({
	...
	return (
		<div
			className="group peer text-sidebar-foreground phone:block hidden"
			data-state={state}
		...
		>
			...
			<div
				...
				className={cn(
					"fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear phone:flex",
					side === "left"
