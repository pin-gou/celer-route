...
func TestCozeCn(t *testing.T) {
	t.Parallel()
	if strings.TrimSpace(os.Getenv("COZE_CN_API_KEY")) == "" {
		t.Skip("Skipping cozecn tests because COZE_CN_API_KEY is not set")
	}
	...
	t.Run("CozeCnTests", func(t *testing.T) {
