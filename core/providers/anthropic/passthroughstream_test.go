...
//
// The fix lives in the transport (transports/celer-route-http/integrations/anthropic.go
...
// passthroughMustConvert mirrors transports/celer-route-http/integrations/anthropic.go
