...
func TestIflytek(t *testing.T) {
	t.Parallel()
	if strings.TrimSpace(os.Getenv("IFLYTEK_API_KEY")) == "" {
		t.Skip("Skipping iflytek tests because IFLYTEK_API_KEY is not set")
	}
	...
	t.Run("IflytekTests", func(t *testing.T) {
