// Package deepinfra implements the DeepInfra LLM provider.
package deepinfra
...
func NewDeepInfraProvider(config *schemas.ProviderConfig, logger schemas.Logger) (*DeepInfraProvider, error) {
	...
	if config.NetworkConfig.BaseURL == "" {
		config.NetworkConfig.BaseURL = "https://api.deepinfra.com/v1/openai"
	}
...
// ListModels performs a list models request to DeepInfra's API.
...
// TextCompletion performs a text completion request to DeepInfra's API.
// It formats the request, sends it to DeepInfra, and processes the response.
...
// TextCompletionStream performs a streaming text completion request to DeepInfra's API.
// It formats the request, sends it to DeepInfra, and processes the response.
...
// ChatCompletion performs a chat completion request to the DeepInfra API.
...
// ChatCompletionStream performs a streaming chat completion request to the DeepInfra API.
// It supports real-time streaming of responses using Server-Sent Events (SSE).
// Uses DeepInfra's OpenAI-compatible streaming format.
...
// Responses performs a responses request to the DeepInfra API by converting it to a chat completion.
...
// ResponsesStream performs a streaming responses request to the DeepInfra API.
...
// Speech is not supported by the DeepInfra provider.
...
// Rerank is not supported by the DeepInfra provider.
...
func (provider *DeepInfraProvider) OCR(ctx *schemas.BifrostContext, key schemas.Key, request *schemas.BifrostOCRRequest) (*schemas.BifrostOCRResponse, *schemas.BifrostError) {
	return nil, providerUtils.NewUnsupportedOperationError(schemas.OCRRequest, provider.GetProviderKey())
}

// SpeechStream is not supported by the DeepInfra provider.
...
// Transcription is not supported by the DeepInfra provider.
...
// TranscriptionStream is not supported by the DeepInfra provider.
func (provider *DeepInfraProvider) TranscriptionStream(ctx *schemas.BifrostContext, postHookRunner schemas.PostHookRunner, postHookSpanFinalizer func(context.Context), key schemas.Key, request *schemas.BifrostTranscriptionRequest) (chan *schemas.BifrostStreamChunk, *schemas.BifrostError) {
	return nil, providerUtils.NewUnsupportedOperationError(schemas.TranscriptionStreamRequest, provider.GetProviderKey())
}

// ImageGeneration performs an image generation request to DeepInfra's API.
...
// ImageGenerationStream is not supported by the DeepInfra provider.
func (provider *DeepInfraProvider) ImageGenerationStream(ctx *schemas.BifrostContext, postHookRunner schemas.PostHookRunner, postHookSpanFinalizer func(context.Context), key schemas.Key, request *schemas.BifrostImageGenerationRequest) (chan *schemas.BifrostStreamChunk, *schemas.BifrostError) {
	return nil, providerUtils.NewUnsupportedOperationError(schemas.ImageGenerationStreamRequest, provider.GetProviderKey())
}

// ImageEdit is not supported by the DeepInfra provider.
...
// ImageEditStream is not supported by the DeepInfra provider.
func (provider *DeepInfraProvider) ImageEditStream(ctx *schemas.BifrostContext, postHookRunner schemas.PostHookRunner, postHookSpanFinalizer func(context.Context), key schemas.Key, request *schemas.BifrostImageEditRequest) (chan *schemas.BifrostStreamChunk, *schemas.BifrostError) {
	return nil, providerUtils.NewUnsupportedOperationError(schemas.ImageEditStreamRequest, provider.GetProviderKey())
}

// ImageVariation is not supported by the DeepInfra provider.
...
// VideoGeneration is not supported by the DeepInfra provider.
func (provider *DeepInfraProvider) VideoGeneration(_ *schemas.BifrostContext, _ schemas.Key, _ *schemas.BifrostVideoGenerationRequest) (*schemas.BifrostVideoGenerationResponse, *schemas.BifrostError) {
	return nil, providerUtils.NewUnsupportedOperationError(schemas.VideoGenerationRequest, provider.GetProviderKey())
}

// VideoRetrieve is not supported by the DeepInfra provider.
func (provider *DeepInfraProvider) VideoRetrieve(_ *schemas.BifrostContext, _ schemas.Key, _ *schemas.BifrostVideoRetrieveRequest) (*schemas.BifrostVideoGenerationResponse, *schemas.BifrostError) {
	return nil, providerUtils.NewUnsupportedOperationError(schemas.VideoRetrieveRequest, provider.GetProviderKey())
}

// VideoDownload is not supported by the DeepInfra provider.
func (provider *DeepInfraProvider) VideoDownload(_ *schemas.BifrostContext, _ schemas.Key, _ *schemas.BifrostVideoDownloadRequest) (*schemas.BifrostVideoDownloadResponse, *schemas.BifrostError) {
...
// CountTokens is not supported by the DeepInfra provider.
...
func (provider *DeepInfraProvider) Compaction(ctx *schemas.BifrostContext, key schemas.Key, request *schemas.BifrostCompactionRequest) (*schemas.BifrostCompactionResponse, *schemas.BifrostError) {
