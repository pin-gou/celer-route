...
func TestBaichuan(t *testing.T) {
	t.Parallel()
	if strings.TrimSpace(os.Getenv("BAICHUAN_API_KEY")) == "" {
		t.Skip("Skipping Baichuan tests because BAICHUAN_API_KEY is not set")
	}
	...
	t.Run("BaichuanTests", func(t *testing.T) {
