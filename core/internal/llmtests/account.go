...
func (account *ComprehensiveTestAccount) GetKeysForProvider(ctx context.Context, providerKey schemas.ModelProvider) ([]schemas.Key, error) {
	...
	case schemas.AlibabaTokenplan:
		return []schemas.Key{
			{
				Value:          *schemas.NewSecretVar("env.ALIBABA_TOKENPLAN_API_KEY"),
				Models:         []string{"*"},
				Weight:         1.0,
				UseForBatchAPI: bifrost.Ptr(true),
			},
	...
	case schemas.Baichuan:
		return []schemas.Key{
			{
				Value:          *schemas.NewSecretVar("env.BAICHUAN_API_KEY"),
				Models:         []string{"*"},
				Weight:         1.0,
				UseForBatchAPI: bifrost.Ptr(true),
			},
	...
	case schemas.Iflytek:
		return []schemas.Key{
			{
				Value:          *schemas.NewSecretVar("env.IFLYTEK_API_KEY"),
				Models:         []string{"*"},
				Weight:         1.0,
				UseForBatchAPI: bifrost.Ptr(true),
			},
	...
	case schemas.Stepfun:
		return []schemas.Key{
			{
				Value:          *schemas.NewSecretVar("env.STEPFUN_API_KEY"),
				Models:         []string{"*"},
				Weight:         1.0,
				UseForBatchAPI: bifrost.Ptr(true),
			},
	...
	case schemas.XiaomiMimo:
		return []schemas.Key{
			{
				Value:          *schemas.NewSecretVar("env.XIAOMI_MIMO_API_KEY"),
				Models:         []string{"*"},
				Weight:         1.0,
				UseForBatchAPI: bifrost.Ptr(true),
			},
	...
	case schemas.Modelscope:
		return []schemas.Key{
			{
				Value:          *schemas.NewSecretVar("env.MODELSCOPE_API_KEY"),
				Models:         []string{"*"},
				Weight:         1.0,
				UseForBatchAPI: bifrost.Ptr(true),
			},
	...
	case schemas.Coze:
		return []schemas.Key{
			{
				Value:          *schemas.NewSecretVar("env.COZE_API_KEY"),
				Models:         []string{"*"},
				Weight:         1.0,
				UseForBatchAPI: bifrost.Ptr(true),
			},
	...
	case schemas.CozeCn:
		return []schemas.Key{
			{
				Value:          *schemas.NewSecretVar("env.COZE_CN_API_KEY"),
				Models:         []string{"*"},
				Weight:         1.0,
				UseForBatchAPI: bifrost.Ptr(true),
			},
	...
	case schemas.GMICloud:
		return []schemas.Key{
			{
				Value:          *schemas.NewSecretVar("env.GMI_API_KEY"),
				Models:         []string{"*"},
				Weight:         1.0,
				UseForBatchAPI: bifrost.Ptr(true),
			},
	...
	case schemas.ThreeSixtyAI:
		return []schemas.Key{
			{
				Value:          *schemas.NewSecretVar("env.AI360_API_KEY"),
				Models:         []string{"*"},
				Weight:         1.0,
				UseForBatchAPI: bifrost.Ptr(true),
			},
	...
	case schemas.InternLM:
		return []schemas.Key{
			{
				Value:          *schemas.NewSecretVar("env.INTERNLM_API_KEY"),
				Models:         []string{"*"},
				Weight:         1.0,
				UseForBatchAPI: bifrost.Ptr(true),
			},
	...
	case schemas.AntLing:
		return []schemas.Key{
			{
				Value:          *schemas.NewSecretVar("env.ANTLING_API_KEY"),
				Models:         []string{"*"},
				Weight:         1.0,
				UseForBatchAPI: bifrost.Ptr(true),
			},
	...
	case schemas.Yi:
		return []schemas.Key{
			{
				Value:          *schemas.NewSecretVar("env.YI_API_KEY"),
				Models:         []string{"*"},
				Weight:         1.0,
				UseForBatchAPI: bifrost.Ptr(true),
			},
	...
	case schemas.QwenCloud:
		return []schemas.Key{
			{
				Value:          *schemas.NewSecretVar("env.QWENCLOUD_API_KEY"),
				Models:         []string{"*"},
				Weight:         1.0,
				UseForBatchAPI: bifrost.Ptr(true),
			},
	...
	case schemas.BytePlus:
		return []schemas.Key{
			{
				Value:          *schemas.NewSecretVar("env.BYTEPLUS_API_KEY"),
				Models:         []string{"*"},
				Weight:         1.0,
				UseForBatchAPI: bifrost.Ptr(true),
			},
	...
	case schemas.Qiniu:
		return []schemas.Key{
			{
				Value:          *schemas.NewSecretVar("env.QINIU_API_KEY"),
				Models:         []string{"*"},
				Weight:         1.0,
				UseForBatchAPI: bifrost.Ptr(true),
			},
