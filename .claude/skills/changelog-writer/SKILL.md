...
```markdown
- [#3795](https://github.com/pin-gou/celer-route/issues/3795) - MCP tools fail with Bedrock provider in v1.5.0
```
...
- [#1234](https://github.com/pin-gou/celer-route/issues/1234) - Issue title
- [#1235](https://github.com/pin-gou/celer-route/issues/1235) - Issue title
```
...
- Add a `## 🐙 Closed GitHub Issues` section listing **every** issue closed in this release (see "Collect Closed GitHub Issues" above). Each entry MUST be a markdown link to the issue: `- [#NUMBER](https://github.com/pin-gou/celer-route/issues/NUMBER) - Issue title`. Omit the section only if no issues were closed.
