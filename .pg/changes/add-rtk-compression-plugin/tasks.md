...
- [ ] 3.2 review agent 对 git diff feat/pg/add-rtk-compression-plugin 做静态审查
...
- [ ] 4.3 启动服务（如需）
- [ ] 4.4 验证 V-core-1：来自 design.md Verification Criteria
...
- [ ] 8.2 review agent 对 git diff feat/pg/add-rtk-compression-plugin 做静态审查
...
- [ ] 9.3 启动服务（如需）
- [ ] 9.4 验证 V-transports-1：来自 design.md Verification Criteria
- [ ] 9.5 验证 V-transports-2：来自 design.md Verification Criteria
...
- [ ] 16.1 确认 `.pg/changes/add-rtk-compression-plugin/scenario-scr.yaml` 存在且每个 Scenario 含 6 段（scenario_id / critical / given / when / then / evidence；and 可选）
